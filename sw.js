const CACHE = 'distritogo-v5-1-nextgen-20260626';
const ASSETS = [
  ...
  'data/config.json','data/cms.json','data/wfm.json','data/bt.json','data/ss.json','data/tbw.json','data/links.json','data/eventos.json','data/actividades_semanales.json','data/actividades_diarias.json','data/duty_roster.json','data/duty_detail.json','data/checklist_apertura.json',
